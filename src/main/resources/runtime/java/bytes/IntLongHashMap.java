...
public final class IntLongHashMap extends AbstractMap<Integer, Long> {
    ...
    public IntLongHashMap(int expectedSize) {
        int capacity = 1;
    ...
    public long getLong(int key) {
        ...
        return index < 0 ? 0L : values[index];
    }

    public Long getBoxed(int key) {
        int index = findIndex(key);
    ...
    public Long put(Integer key, Long value) {
        ...
        putLong(key == null ? 0 : key, value == null ? 0L : value);
        return previous;
    }
    ...
    public Set<Entry<Integer, Long>> entrySet() {
        return new AbstractSet<>() {
            ...
            public Iterator<Entry<Integer, Long>> iterator() {
                return new Iterator<>() {
                    private final Cursor cursor = new Cursor(IntLongHashMap.this);
                    ...
                    public Entry<Integer, Long> next() {
                        ...
                        return new SimpleImmutableEntry<>(cursor.key(), cursor.valueLong());
                    }
                };
            }
